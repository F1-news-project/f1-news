              ...
              <div className="inline-flex items-center">
                ...
                >
                  <input
                    ...
                    id="check"
                    checked={isFeatured}
                    disabled={featuredArticle && true}
                    onChange={(e) => setIsFeatured(!isFeatured)}
                  />
                  <span
                    className="absolute text
                  -white transition-opacity opacity-0 pointer-events-none top-2/4 left-2/4 -translate-y-2/4 -translate-x-2/4 peer-checked:opacity-100"
                  >
                    <svg
                ...
                <label
                  className="mt-px font-light text
                  -gray-700 cursor-pointer select-none"
                  htmlFor="check"
                >
                  Featured Article
                </label>
